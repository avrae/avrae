...
class GameLog(commands.Cog):
    ...
    async def campaign(self, ctx, campaign_link=None):
        ...
        You must be the DM of the campaign to link it to a channel. This link should be the url visible on your web browser when you are viewing your campaign and *not* the join link.
