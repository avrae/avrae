...
class MonsterCombatant(Combatant):
    ...
    @classmethod
    def from_monster(cls, monster, ctx, combat, name, controller_id, init, private, cust={}, stats=None, skills=None, saves=None, hp=None, ac=None):
        ...
        stats=(monster.stats if stats==None else stats)
        skills=(monster.skills if skills==None else skills)
        saves=(monster.saves if saves==None else saves)
