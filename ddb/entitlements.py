class UserEntitlements:
    ...
    def from_dict(cls, d):
        return cls(
            d["acquiredLicenseIDs"],
            [SharedLicense.from_dict(sl) for sl in d["sharedLicenses"]],
        )
    ...
    def licenses(self):
        ...
        :rtype: set[int]
        """
        return set(self.acquired_license_ids).union(
            *(sl.license_ids for sl in self.shared_licenses)
        )
