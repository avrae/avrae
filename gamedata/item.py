...
class AdventuringGear(DescribableMixin, Sourced):
...
class Armor(DescribableMixin, Sourced):
    entity_type = "armor"
    type_id = 701257905
...
class MagicItem(DescribableMixin, Sourced):
...
class Weapon(DescribableMixin, Sourced):
    entity_type = "weapon"
    type_id = 1782728300
