...
async def test_naughty_yaml(draconic_evaluator):
    ...
    extra_expressions = {
        ...
        """: {'Bestiary': [('aardvark', 'African pig-like ant eater. Ugly.'),
                           ('anteater', 'South-American ant eater. Two species.'),
                           ('anaconda', 'South-American constrictor snake. Scaly.')]},
        """
        # pairs: Safe
        Block tasks: !!pairs
          ...
          - break: lunch.
          - meeting: with client.
        """: {'Block tasks': [('meeting', 'with team.'), ('meeting', 'with boss.'), ('break', 'lunch.'),
                              ('meeting', 'with client.')]},
        """
        # set: safe
        ...
        logical: True
        option: on
        """: {'canonical': 'y', 'answer': False, 'logical': True, 'option': True},
        """
        # floats
        ...
        floater: !!float 0
        """: {'canonical': 685230.15, 'exponentioal': 685230.15, 'fixed': 685230.15, 'sexagesimal': 685230.15,
              'floater': 0.0},
        """
        # ints
        canonical: 685230
        ...
        """: {'canonical': 685230, 'decimal': 685230, 'octal': 685230, 'hexadecimal': 685230, 'binary': 685230,
              'sexagesimal': 685230},
        """
        # nulls
        sparse:
        ...
        english: null
        ~: null key
        """: {'sparse': [None, '2nd entry', None, '4th entry', None], 'empty': None, 'canonical': None, 'english': None,
              None: 'null key'},
        """
        # timestamps
        ...
        """: {'canonical': '2001-12-15T02:59:43.1Z', 'valid iso8601': '2001-12-14t21:59:43.10-05:00',
              'space separated': '2001-12-14 21:59:43.10 -5', 'no time zone (Z)': '2001-12-15 2:59:43.10',
              'date (00:00:00Z)': '2002-12-14'},
        """
