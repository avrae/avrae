...
async def test_mc(avrae, dhttp):
    ...
    await dhttp.receive_message(
        embed=discord.Embed(
            title="A Kobold makes an Acrobatics check!", description=D20_PATTERN
        )
    )
...
async def test_ms(avrae, dhttp):
    ...
    await dhttp.receive_message(
        embed=discord.Embed(
            title="A Kobold makes a Dexterity Save!", description=D20_PATTERN
        )
    )
    ...
    await dhttp.receive_message(
        embed=discord.Embed(
            title="An unknown creature makes a Dexterity Save!", description=D20_PATTERN
        )
    )
