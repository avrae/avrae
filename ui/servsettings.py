    ...
    async def get_content(self):
        ...
        embed.add_field(
            ...
            value=(
                ...
                "*If this is enabled, users are able to use their own character version vs being locked to the server version.*"  # noqa: E501
            ),
            inline=False,
        )
        embed.add_field(
            ...
            value=(
                ...
                "*If this is enabled, all lookup selections will use interactive buttons instead of text-based selection.*"  # noqa: E501
            ),
            inline=False,
        )
        return {"embed": embed}
