...
RELOAD_INTERVAL = os.getenv(
    "RELOAD_INTERVAL", "0"
)  # compendium static data reload interval
...
)  # optional - if not supplied, uses avrae-google.json
...
DDB_GAMELOG_ENDPOINT = os.getenv(
    "DDB_GAMELOG_ENDPOINT", "https://game-log-rest-live.dndbeyond.com/v1"
)
DDB_CHARACTER_SERVICE_URL = os.getenv(
    "DDB_CHARACTER_SERVICE_URL", "https://character-service.dndbeyond.com/character/v5"
)
DDB_SCDS_SERVICE_URL = os.getenv(
    "DDB_SCDS_SERVICE_URL", "https://character-service-scds.dndbeyond.com/v1"
)
